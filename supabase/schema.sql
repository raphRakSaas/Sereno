...
insert into public.categories (id, user_id, name, type, icon, color, display_order, is_archived) values
  ('c0000000-0000-4000-8000-000000000001', null, 'Salaire', 'income', 'work', '#0EA5E9', 0, false),
  ('c0000000-0000-4000-8000-000000000012', null, 'Freelance & indépendant', 'income', 'pencil', '#6366F1', 1, false),
  ('c0000000-0000-4000-8000-000000000013', null, 'Allocations & aides familiales', 'income', 'gift', '#A855F7', 2, false),
  ('c0000000-0000-4000-8000-000000000014', null, 'APL & aide au logement', 'income', 'home', '#14B8A6', 3, false),
  ('c0000000-0000-4000-8000-000000000015', null, 'Prestations sociales', 'income', 'health', '#22C55E', 4, false),
  ('c0000000-0000-4000-8000-000000000016', null, 'Pension & retraite', 'income', 'wallet', '#84CC16', 5, false),
  ('c0000000-0000-4000-8000-000000000017', null, 'Revenus locatifs', 'income', 'building', '#EAB308', 6, false),
  ('c0000000-0000-4000-8000-000000000018', null, 'Dividendes & intérêts', 'income', 'chart', '#0891B2', 7, false),
  ('c0000000-0000-4000-8000-000000000019', null, 'Plus-values & placements', 'income', 'sparkle', '#059669', 8, false),
  ('c0000000-0000-4000-8000-00000000001a', null, 'Remboursements reçus', 'income', 'arrow-in', '#7C3AED', 9, false),
  ('c0000000-0000-4000-8000-000000000002', null, 'Autres revenus', 'income', 'dots', '#64748B', 10, false),
  ('c0000000-0000-4000-8000-000000000003', null, 'Logement', 'expense', 'home', '#3B82F6', 20, false),
  ('c0000000-0000-4000-8000-000000000004', null, 'Courses', 'expense', 'basket', '#10B981', 21, false),
  ('c0000000-0000-4000-8000-000000000005', null, 'Transports', 'expense', 'transit', '#06B6D4', 22, false),
  ('c0000000-0000-4000-8000-000000000006', null, 'Restaurants & cafés', 'expense', 'dining', '#F97316', 23, false),
  ('c0000000-0000-4000-8000-000000000007', null, 'Santé', 'expense', 'health', '#EC4899', 24, false),
  ('c0000000-0000-4000-8000-000000000008', null, 'Loisirs', 'expense', 'leisure', '#8B5CF6', 25, false),
  ('c0000000-0000-4000-8000-000000000009', null, 'Abonnements', 'expense', 'repeat', '#F59E0B', 26, false),
  ('c0000000-0000-4000-8000-000000000010', null, 'Vêtements', 'expense', 'clothing', '#D946EF', 27, false),
  ('c0000000-0000-4000-8000-000000000011', null, 'Autres dépenses', 'expense', 'dots', '#6B7280', 28, false)
